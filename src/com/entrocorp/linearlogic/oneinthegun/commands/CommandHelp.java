...
public class CommandHelp extends OITGCommand {
    ...
    private static String[] commands = {"addspawn <arena>", "arenas [state]", "clearspawns <arena>", "close <arena>",
        ...
        "loadlisteners", "open <arena>", "reload", "rename <arena> <name>", "save <arena>", "search <username>",
        "setgloballobby", "setlobby <arena>", "settings <arena> <setting> <value>", "version"};
    ...
    private static String[] descriptions = {"place an arena spawn point at your location", "list arenas by state",
        ...
        "arena or empty an entire arena", "display the kill-death leaderboard for an arena", "leave an arena",
        "reload custom killstreak and victory listeners", "open a closed arena", "reload the plugin configuration",
        "rename an arena", "save an edited arena", "lookup the arena in which a user is playing", "place the global " +
        "lobby at your location", "place the lobby of an arena", "modify an arena setting", "display the plugin version"};
